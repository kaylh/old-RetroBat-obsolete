...
SectionInstType ${IT_REQUIRED_02} ${IT_REQUIRED_03} ${IT_REQUIRED_04}
	...
	${CheckUserAborted}
	inetc::get "https://www.retrobat.ovh/repo/v3/EmulationStation-Win32.zip" "${DOWNLOAD_DIR}\emulationstation.zip" /END
	installES:
	${CheckUserAborted}
...
inetc::get "https://www.retrobat.ovh/repo/emulators/libretro/${OS_ARCHITECTURE}/cores/$LRCORE_libretro.dll.zip" "${DOWNLOAD_DIR}\$LRCORE_libretro.dll.zip" /END
LRCORE01:
${CheckUserAborted}

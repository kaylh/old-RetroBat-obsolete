...
!define BIOS_SOURCE "${BASE_SOURCE}\bios"
!define BIOS_TARGET "$INSTDIR\bios"
!define DECORATIONS_SOURCE "${BASE_SOURCE}\system\decorations"
!define DECORATIONS_TARGET "$INSTDIR\system\decorations"
!define EMULATIONSTATION_SOURCE "${BASE_SOURCE}\emulationstation"
!define EMULATIONSTATION_TARGET "$INSTDIR\emulationstation"
!define EMULATORS_SOURCE "${BASE_SOURCE}\emulators"
!define EMULATORS_TARGET "$INSTDIR\emulators"
!define GAMES_SOURCE "${BASE_SOURCE}\roms"
!define GAMES_TARGET "$INSTDIR\roms"
!define SYSTEM_SOURCE "${BASE_SOURCE}\system"
!define SYSTEM_TARGET "${BASE_SOURCE}\system"
!define RESOURCES_PATH "${SYSTEM_SOURCE}\resources"

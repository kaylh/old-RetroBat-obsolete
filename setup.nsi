...
*/
  ...
  !define PRODUCT_VERSION "3.10-dev"
  !define VERSION "${PRODUCT_VERSION}"
  !define RETROARCH_VERSION "1.8.8"
  !define OS_ARCHITECTURE "x86_64"
; !define AFTER_INSTALLATION_URL "https://www.retrobat.ovh"
  

  Name "${PRODUCT}"
;  OutFile "Setup-${PRODUCT}-v${VERSION}-${OS_ARCHITECTURE}.exe"
  OutFile "setup.exe"
...
;  ShowInstDetails "show"
  ...
  !define MUI_ICON "G:\Projets\RetroBat-Setup\RetroBat-Setup\setup.ico"
  !define MUI_COMPONENTSPAGE_NODESC
  
  !define MUI_HEADERIMAGE
  !define MUI_HEADERIMAGE_BITMAP "G:\Projets\RetroBat-Setup\RetroBat-Setup\res\header.bmp"
  !define MUI_HEADERIMAGE_BITMAP_STRETCH "FitControl"
;  !define MUI_HEADERIMAGE_RIGHT
  !define MUI_WELCOMEFINISHPAGE_BITMAP "G:\Projets\RetroBat-Setup\RetroBat-Setup\res\wizard.bmp"
...
;  !define MUI_WELCOMEPAGE_TITLE_3LINES
;  !define MUI_WELCOMEPAGE_LINK "RetroBat Official Website"
;  !define MUI_WELCOMEPAGE_LINK_LOCATION "http://www.retrobat.ovh/"

!define MUI_PAGE_CUSTOMFUNCTION_SHOW InstFilesShow

;  !insertmacro MUI_PAGE_WELCOME
  !insertmacro MUI_PAGE_LICENSE "G:\Projets\RetroBat-Setup\RetroBat-Setup\licence.txt"
...
SectionGroup "RetroBat"
	...
	StrCpy $PKGNAME "retrobat-stable.zip"
	
	SetOutPath "${DOWNLOAD_DIR}"		
	inetc::get "https://www.retrobat.ovh/repo/v3/retrobat-stable.zip" "${DOWNLOAD_DIR}\$PKGNAME" /END
	nsisunz::UnzipToStack "${DOWNLOAD_DIR}\$PKGNAME" "$INSTDIR"
	Delete "${DOWNLOAD_DIR}\$PKGNAME"
	
	SectionEnd
	
	Section "Systems Database"
	...
	SetOutPath "${DOWNLOAD_DIR}"		
	inetc::get "https://www.retrobat.ovh/repo/v3/bios-base.zip" "${DOWNLOAD_DIR}\$PKGNAME" /END
	nsisunz::UnzipToStack "${DOWNLOAD_DIR}\$PKGNAME" "$INSTDIR\bios"
	Delete "${DOWNLOAD_DIR}\$PKGNAME"
...
*/   
  ...
  SectionEnd
	...
	SectionGroup "EmulationStation"
		...
		nsisunz::UnzipToStack "$INSTDIR\$PKG_DIR\$PKGNAME" "$INSTDIR\$PKG_DIR"
...
*/		
		...
		SetOutPath "$INSTDIR\$PKG_DIR"		
		inetc::get "http://www.retrobat.ovh/repo/v3/batocera-ports.zip" "$INSTDIR\$PKG_DIR\$PKGNAME" /END
		nsisunz::UnzipToStack "$INSTDIR\$PKG_DIR\$PKGNAME" "$INSTDIR\$PKG_DIR"
		Delete "$INSTDIR\$PKG_DIR\$PKGNAME"
	...
	SectionGroup "Themes"
			...
			SectionInstType ${IT_REQUIRED_01} ${IT_REQUIRED_06}
				...
				StrCpy $PKG_DIR "emulationstation\.emulationstation\themes\es-theme-carbon"
				StrCpy $PKGNAME "es-theme-carbon.zip"
		

				SetOutPath "$INSTDIR\$PKG_DIR"		
				inetc::get "https://www.retrobat.ovh/repo/v3/$PKGNAME" "$INSTDIR\$PKG_DIR\$PKGNAME" /END
				nsisunz::UnzipToStack "$INSTDIR\$PKG_DIR\$PKGNAME" "$INSTDIR\$PKG_DIR"
				Delete "$INSTDIR\$PKG_DIR\$PKGNAME"
...
SectionGroup "RetroArch"
	...
	SectionEnd
		...
		SetOutPath "$INSTDIR\$PKG_DIR"		
		inetc::get "https://buildbot.libretro.com/assets/frontend/database-rdb.zip" "$INSTDIR\$PKG_DIR\$PKGNAME" /END
		nsisunz::UnzipToStack "$INSTDIR\$PKG_DIR\$PKGNAME" "$INSTDIR\$PKG_DIR"
		Delete "$INSTDIR\$PKG_DIR\$PKGNAME"
	...
	SectionInstType ${IT_REQUIRED_01} ${IT_REQUIRED_02} ${IT_REQUIRED_03} ${IT_REQUIRED_04} ${IT_REQUIRED_05}
		...
		SetOutPath "$INSTDIR\$PKG_DIR"		
		inetc::get "https://buildbot.libretro.com/assets/frontend/info.zip" "$INSTDIR\$PKG_DIR\$PKGNAME" /END
		nsisunz::UnzipToStack "$INSTDIR\$PKG_DIR\$PKGNAME" "$INSTDIR\$PKG_DIR"
		Delete "$INSTDIR\$PKG_DIR\$PKGNAME"
	...
	SectionInstType ${IT_REQUIRED_01} ${IT_REQUIRED_02} ${IT_REQUIRED_03} ${IT_REQUIRED_04} ${IT_REQUIRED_05} ${IT_REQUIRED_06}
		...
		SetOutPath "$INSTDIR\$PKG_DIR"		
		inetc::get "http://www.retrobat.ovh/repo/v3/shaders.zip" "$INSTDIR\$PKG_DIR\$PKGNAME" /END
		nsisunz::UnzipToStack "$INSTDIR\$PKG_DIR\$PKGNAME" "$INSTDIR\$PKG_DIR"
		Delete "$INSTDIR\$PKG_DIR\$PKGNAME"
	...
	SectionInstType ${IT_REQUIRED_01} ${IT_REQUIRED_02} ${IT_REQUIRED_03} ${IT_REQUIRED_04} ${IT_REQUIRED_05} ${IT_REQUIRED_06}
		...
		SetOutPath "$INSTDIR\$PKG_DIR"		
		inetc::get "https://github.com/kaylh/RetroArch-Bezels/releases/download/1.0/retroarch-bezels.zip" "$INSTDIR\$PKG_DIR\$PKGNAME" /END
		nsisunz::UnzipToStack "$INSTDIR\$PKG_DIR\$PKGNAME" "$INSTDIR\$PKG_DIR"
		Delete "$INSTDIR\$PKG_DIR\$PKGNAME"
...
SectionGroup "Libretro Cores Pack"
		...
		SectionInstType ${IT_REQUIRED_01} ${IT_REQUIRED_02} ${IT_REQUIRED_03} ${IT_REQUIRED_04} ${IT_REQUIRED_05}
			...
			nsisunz::UnzipToStack "$INSTDIR\emulators\retroarch\cores\$LRCORE_libretro.dll.zip" "$INSTDIR\$PKG_DIR"		
...
SectionGroupEnd
	...
	SectionGroupEnd
		...
		Section "snes9x2005_plus"
		
			AddSize 1500

			StrCpy $LRCORE "snes9x2005_plus"
			StrCpy $PKG_DIR "emulators\retroarch\cores"
			SetOutPath "$INSTDIR\emulators\retroarch\cores"
			inetc::get "https://buildbot.libretro.com/nightly/windows/${OS_ARCHITECTURE}/latest/$LRCORE_libretro.dll.zip" "$INSTDIR\emulators\retroarch\cores\$LRCORE_libretro.dll.zip" /END
			nsisunz::UnzipToStack "$INSTDIR\emulators\retroarch\cores\$LRCORE_libretro.dll.zip" "$INSTDIR\$PKG_DIR"			
...
SectionGroup "Standalone Emulators"
	...
	nsisunz::UnzipToStack "${DOWNLOAD_DIR}\$PKGNAME" "$INSTDIR\$PKG_DIR"
	Delete "${DOWNLOAD_DIR}\$PKGNAME"
	...
	SectionInstType ${IT_REQUIRED_01} ${IT_REQUIRED_02} ${IT_REQUIRED_03} ${IT_REQUIRED_04} ${IT_REQUIRED_05}
		...
		StrCpy $PKG_DIR "emulators\dolphin-emu"
	...
	SectionInstType ${IT_REQUIRED_01} ${IT_REQUIRED_02} ${IT_REQUIRED_03} ${IT_REQUIRED_04} ${IT_REQUIRED_05}
		...
		StrCpy $PKG_DIR "emulators\pcsx2"
	...
	SectionInstType ${IT_REQUIRED_01} ${IT_REQUIRED_02} ${IT_REQUIRED_03} ${IT_REQUIRED_04} ${IT_REQUIRED_05}
		...
		StrCpy $PKG_DIR "emulators\demul"
		...
		StrCpy $PKG_DIR "emulators\demul-old"
		StrCpy $PKGNAME "demul.7z"
	...
	SectionInstType ${IT_REQUIRED_01} ${IT_REQUIRED_02} ${IT_REQUIRED_03} ${IT_REQUIRED_04} ${IT_REQUIRED_05}
		...
		StrCpy $PKG_DIR "emulators\openbor"

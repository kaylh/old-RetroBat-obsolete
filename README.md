# This repository is now obsolete and read-only. Please consider instead the new project here: [https://github.com/RetroBat-Official](https://github.com/RetroBat-Official)
